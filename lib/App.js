...
module.exports = Class.extend({
  ...
  init: function init(options) {
    ...
    // Expect one of "debug", "dev", "test", "stage", "beta", "canary", "prod".
  ...
  initChug: function initChug() {
    ...
    var autoScripts = configScripts['/a.js'] = configScripts['/a.js'] || [];
    autoScripts.unshift.apply(autoScripts, app.autoScripts);
    ...
    app.chug.onceReady(function () {
      ...
      if (app.isDev) {
        ...
        app.watchAndExit('.', /^(\..*|controllers|coverage|node_modules|public|scripts|styles|test|uploads|views)$/);
        ...
        app.logger.warn("[Lighter] Minifying assets... " + grey + "(to disable, run \"lighter dev\")" + base);
        app.views.minify();
