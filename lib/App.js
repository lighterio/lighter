...
var lighter = require(lighterDir + '/lighter.js');
var Emitter = require(libDir + '/common/emitter.js');
var Class = require(libDir + '/Class.js');
var Model = require(libDir + '/Model.js');
var Controller = require(libDir + '/Controller.js');
require(libDir + '/Response.js');
...
module.exports = Class.extend({
  ...
  initLogger: function () {
    ...
    if (logger instanceof Array) {
      logger = require(modulesDir + '/cedar/cedar.js')(logger);
    }
    else {
      try {
  ...
  initCache: function () {
    ...
    if (!cache.get) {
      ...
      var mc = require(modulesDir + '/mc/lib/memcache-client.js');
  ...
  initSplode: function () {
    ...
    if (app.config.enableSplode) {
      var splode = app.splode = require(modulesDir + '/splode/splode.js');
  ...
  serve: function () {
    var app = this;
    app.server = app.config.server || require(modulesDir + '/za/za.js')();
    app.server.listen({
  ...
  initChug: function () {
    ...
    app.chug = require(modulesDir + '/chug/chug.js');
    app.chug.setServer(app.server);
    app.chug.enableShrinking();
    app.chug.setCompiler('ltl', modulesDir + '/ltl/ltl.js');
    ...
    ['models', 'controllers'].forEach(function (key) {
      ...
      var load = app[key] = app.chug(app.config[key])
        .require(function (Class) {
          if (!Class.extend) {
            Class = this.module = Constructor.extend(Class);
          }
  ...
  initBeams: function () {
    ...
    app.beams = require(modulesDir + '/beams/beams.js');
  ...
  initD6: function () {
    ...
    setImmediate(function () {
      require(modulesDir + '/d6/d6.js')(app);
    });
  },
