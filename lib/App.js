  ...
  initChug: function initChug() {
    ...
    app.chug.onceReady(function () {
      ...
      if (app.config.env == 'dev') {
        ...
        // Watch Lighter and its dependencies if you're a contributor.
        if (app.config.developingFramework) {
          app.watchAndExit('./node_modules/lighter', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/beams', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/cedar', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/chug', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/d6', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/jymin', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/ltl', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/ormy', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/splode', /^node_modules$/);
          app.watchAndExit('./node_modules/lighter/node_modules/za', /^node_modules$/);
        }
